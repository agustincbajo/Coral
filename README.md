...
[![Tests](https://img.shields.io/badge/tests-583%20passing-brightgreen)](#testing--ci)
...
```bash
cargo test --workspace                        # 583 tests passing
