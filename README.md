...
[![Tests](https://img.shields.io/badge/tests-592%20passing-brightgreen)](#testing--ci)
...
```bash
cargo test --workspace                        # 592 tests passing
...
### Test breakdown (v0.14.0)

| Crate / target | Tests |
|---|---|
| `coral-core` (lib + benches) | 103 + 2 ignored (real-git smoke) |
