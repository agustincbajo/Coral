...
```bash
cargo install --locked --git https://github.com/agustincbajo/Coral --tag v0.19.6 coral-cli
```
...
```bash
curl -L -o coral.tar.gz https://github.com/agustincbajo/Coral/releases/download/v0.19.6/coral-v0.19.6-aarch64-apple-darwin.tar.gz
shasum -a 256 -c coral.tar.gz.sha256  # if you also downloaded the .sha256 sidecar
tar -xzf coral.tar.gz
sudo mv coral-v0.19.6-aarch64-apple-darwin/coral /usr/local/bin/
coral --version
```
